 ...
 * @method static GstInvoiceModel forceUpdateInvoice(GstInvoiceModel $invoice, mixed $recipient = null, ?array $items = null, ?InvoiceOptions $options = null, array $additionalAttributes = [])
