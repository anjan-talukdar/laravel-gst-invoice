...
class BillOfSupplyService
{
    ...
    {
        return $this->service->createBillOfSupply($recipient, $items, $options);
    }

    public function issue(GstInvoice $billOfSupply): GstInvoice
    {
        return $this->service->issueDocument($billOfSupply);
    }

    public function cancel(GstInvoice $billOfSupply, ?string $reason = null, mixed $cancelledBy = null): bool
    {
